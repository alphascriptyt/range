...
int main(int argc, char** argv) {
	...
	V3 pos_x(0, 0, 0);
	V3 size_x(10, 1, 1);
	Mesh mesh_x(Cube::vertices, Cube::faces, pos_x, size_x, COLOUR::GOLD);
	
	V3 pos_y(0, 1, 0);
	V3 size_y(1, 10, 1);
	Mesh mesh_y(Cube::vertices, Cube::faces, pos_y, size_y, COLOUR::AQUA);

	V3 pos_z(0, 0, 1);
	V3 size_z(1, 1, 10);
	Mesh mesh_z(Cube::vertices, Cube::faces, pos_z, size_z, COLOUR::RED);
